...
| 里程碑 | 内容 | 出口 |
|---|---|---|
| C3 | 类型检查/效果/own 等静态语义(§2–§8) | tests/README.md 规则下 61 文件语义全绿 |
| C4 | 执行层(CVM/后端) | 自举种子就绪:ctron0-C 可编译 Ctron 写的模块 |

计划文档:C1 `docs/superpowers/plans/2026-09-05-c-lexer.md`;C2 `docs/superpowers/plans/2026-09-05-c-parser.md`。
