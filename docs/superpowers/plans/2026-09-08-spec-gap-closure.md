...
| Phase 3 模块与包 | use 生效、多文件程序、pub(pkg)/字段可见性、E5010 孤儿、E5020 循环依赖、Ctron.toml | **v0 已落**(2026-09-09:use 合并/可见性 E2020/循环 E5020/pub(pkg);E5010/E4010/E6010 由宿主 pkg oracle 承担,自举侧待切片) |
