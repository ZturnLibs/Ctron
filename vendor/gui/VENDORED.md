...
| SheenBidi | — | 下载未通(网络),VENDORED 待重试 | MIT | bidi/shaping(M3) | 待拉取 | https://github.com/nicbarker/clay/archive/refs/tags/v0.14.tar.gz | zlib(见上游 LICENSE) | 仅单头 `clay.h` | 2026-09-16 |
