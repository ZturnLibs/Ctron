// ft_shim.c —— gui_cjk 示例 shim(同步自 tests/gui/s9_window_cjk;阶梯修复时随 PR 手动同步)
// 示例副本增量:ft_last_w/ft_last_h/ft_probe_nonzero(headless 渲染冒烟读出口;上游夹具暂未用)
...
// ---- headless 冒烟探针(示例副本增量):最近一次 ft_render 的缓冲读出口 ----
