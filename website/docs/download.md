...
Every release ships 8 assets, all reachable at `https://github.com/Zturn/Ctron/releases/latest/download/<asset>`. Version numbers carry no `v` prefix; v0.0.1 shown as the example:
...
| [ctron-0.0.1-windows-x86_64.zip](https://github.com/Zturn/Ctron/releases/latest/download/ctron-0.0.1-windows-x86_64.zip) | Windows x86_64 (beta) |
| [ctron-0.0.1-src.tar.gz](https://github.com/Zturn/Ctron/releases/latest/download/ctron-0.0.1-src.tar.gz) | Source line (pre-emitted C included, cc-only) |
| [SHA256SUMS](https://github.com/Zturn/Ctron/releases/latest/download/SHA256SUMS) | SHA-256 checksums for the six release artifacts |
| [install.sh](https://github.com/Zturn/Ctron/releases/latest/download/install.sh) | One-liner install script |
